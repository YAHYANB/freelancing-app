                ...
                <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                        ...
                        <div class="bg-white shadow-xl rounded-lg sticky top-24  p-6">
                            <div class="flex flex-col items-center gap-1">
                                <div className="relative">
                                    <img src="https://randomuser.me/api/portraits/men/94.jpg" class="w-28 h-28 bg-gray-300 rounded-full " />
                    ...
                    <div class="col-span-4 sm:col-span-9">
                        <div class="bg-white p-6 flex flex-col gap-8">
                            ...
                            <div>
                                <h2 class="text-gray-700 font-semibold tracking-wider mt-6 mb-4">Experience :</h2>
                                <div class="mb-6">
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {gigs.map((gig) => (
                                        <div class="bg-white rounded-sm overflow-hidden shadow-lg w-64 ml-2">
